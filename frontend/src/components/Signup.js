                    ...
                    <form onSubmit={handleSubmit} noValidate className='space-y-4'>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full border rounded-lg text-sm py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-colors ${errors.name ? 'border-red-400 bg-red-50' : 'border-gray-300'}`}
